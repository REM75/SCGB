...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'ambrelouise_supply.loan.handler' => 'getAmbrelouiseSupply_Loan_HandlerService',
            'ambrelouise_supply.serial_number.pdf' => 'getAmbrelouiseSupply_SerialNumber_PdfService',
            'ambrelouise_supply.supply.handler' => 'getAmbrelouiseSupply_Supply_HandlerService',
    ...
    /**
     * Gets the 'ambrelouise_supply.loan.handler' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return Ambrelouise\SupplyBundle\Handler\LoanHandler A Ambrelouise\SupplyBundle\Handler\LoanHandler instance.
     */
    protected function getAmbrelouiseSupply_Loan_HandlerService()
    {
        return $this->services['ambrelouise_supply.loan.handler'] = new \Ambrelouise\SupplyBundle\Handler\LoanHandler($this);
    }

    /**
     * Gets the 'ambrelouise_supply.serial_number.pdf' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return Ambrelouise\SupplyBundle\Pdf\SerialNumberPdf A Ambrelouise\SupplyBundle\Pdf\SerialNumberPdf instance.
     */
    protected function getAmbrelouiseSupply_SerialNumber_PdfService()
    {
        $this->services['ambrelouise_supply.serial_number.pdf'] = $instance = new \Ambrelouise\SupplyBundle\Pdf\SerialNumberPdf();

        $instance->setContainer($this, $this->get('translator'));

        return $instance;
    }

    /**
     * Gets the 'ambrelouise_supply.supply.handler' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return Ambrelouise\SupplyBundle\Handler\SupplyHandler A Ambrelouise\SupplyBundle\Handler\SupplyHandler instance.
     */
    protected function getAmbrelouiseSupply_Supply_HandlerService()
    {
        return $this->services['ambrelouise_supply.supply.handler'] = new \Ambrelouise\SupplyBundle\Handler\SupplyHandler($this);
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $d->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($this->get('annotation_reader'), array(0 => 'C:\\wamp\\www\\Symfony\\src\\SCGB\\DevisBundle\\Entity')), 'SCGB\\DevisBundle\\Entity');

        $e = new \Doctrine\ORM\Configuration();
        $e->setEntityNamespaces(array('SCGBDevisBundle' => 'SCGB\\DevisBundle\\Entity'));
    ...
    {
        return $this->services['form.csrf_provider'] = new \Symfony\Component\Form\Extension\Csrf\CsrfProvider\SessionCsrfProvider($this->get('session'), '6a4304f61bc13c19f7939086161510517');
    }
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath('C:\\wamp\\www\\Symfony\\src\\SCGB\\DevisBundle/Resources/views', 'SCGBDevis');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('6a4304f61bc13c19f7939086161510517');
    }
    ...
    {
        return $this->services['validator.mapping.class_metadata_factory'] = new \Symfony\Component\Validator\Mapping\ClassMetadataFactory(new \Symfony\Component\Validator\Mapping\Loader\LoaderChain(array(0 => new \Symfony\Component\Validator\Mapping\Loader\AnnotationLoader($this->get('annotation_reader')), 1 => new \Symfony\Component\Validator\Mapping\Loader\StaticMethodLoader(), 2 => new \Symfony\Component\Validator\Mapping\Loader\XmlFilesLoader(array(0 => 'C:\\wamp\\www\\Symfony\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/config/validation.xml')), 3 => new \Symfony\Component\Validator\Mapping\Loader\YamlFilesLoader(array(0 => 'C:\\wamp\\www\\Symfony\\src\\SCGB\\DevisBundle\\Resources\\config\\validation.yml')))), NULL);
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'SCGBDevisBundle' => 'SCGB\\DevisBundle\\SCGBDevisBundle',
            ...
            'locale' => 'en',
            'secret' => '6a4304f61bc13c19f7939086161510517',
            'database_path' => NULL,
            ...
            'kernel.secret' => '6a4304f61bc13c19f7939086161510517',
            ...
            'validator.mapping.loader.yaml_files_loader.mapping_files' => array(
                0 => 'C:\\wamp\\www\\Symfony\\src\\SCGB\\DevisBundle\\Resources\\config\\validation.yml',
            ),
